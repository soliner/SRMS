package cn.mnsrc.patent.web.servlet;
...
import cn.mnsrc.patent.service.PatentService;


public class PatentServlet extends BaseServlet {
	...
	public String add(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Patent s = CommonUtils.toBean(request.getParameterMap(), Patent.class);
	...
	public String preEdit(HttpServletRequest request, HttpServletResponse response)
		...
		Patent rp = patentService.load(pid);
		request.setAttribute("rp", rp);
		return "f:/scienceResearchResult/editPatent.jsp";

	}

	public String edit(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		Patent s = CommonUtils.toBean(request.getParameterMap(), Patent.class);
		patentService.edit(s);
	...
	public String delete(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
		String pid = request.getParameter("pid");
		patentService.delete(pid);
		request.setAttribute("msg", "删除成功");
		return "f:/msg.jsp";
	}

	public String query(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		Patent criteria = CommonUtils.toBean(request.getParameterMap(), Patent.class);
		//request.setAttribute("criteria", criteria);
		criteria = endcoding(criteria);
		int pc = getPc(request);
		int ps = 10;
		PageBean<Patent> pb = patentService.query(criteria, pc, ps);
		pb.setUrl(getUrl(request));
		request.setAttribute("pb", pb);
		return "f:/scienceResearchResult/patent.jsp";
	...
	private Patent endcoding(Patent criteria) throws UnsupportedEncodingException {
